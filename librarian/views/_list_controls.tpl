<p class="list-controls" id="controls">
    ...
    <a class="sel-all button small" href="${i18n_path(h.set_qparam(sel=1))}">${_('Select all')}</a>
    ## Translators, used as button label on updates page for unmarking all content for import
    <a class="sel-none button small" href="${i18n_path(h.set_qparam(sel=0))}">${_('Select none')}</a>
