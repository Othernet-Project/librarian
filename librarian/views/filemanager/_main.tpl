...
<div id="views-tabs-container">
    <nav id="views-tabs-strip" class="views-tabs-strip" role="tablist">
        ...
        <% h.urlquote %>
        % if is_search:
            <a href="${i18n_url('filemanager:list', path=current.parent)}"
                    data-relpath="${current.parent | h.urlquote}"
                    class="views-tabs-strip-tab views-tabs-special views-tabs-tab-go-back">
