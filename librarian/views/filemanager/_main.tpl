...
<div id="views-tabs-container">
    <nav id="views-tabs-strip" class="views-tabs-strip" role="tablist">
        ...
        % if is_search or not is_successful:
            <a href="${i18n_url('filemanager:filelist', path='')}" class="views-tabs-strip-tab views-tabs-special">
        ...
        % elif path != '.':
            ...
            <a href="${i18n_url('filemanager:filelist', path=up)}" class="views-tabs-strip-tab views-tabs-special">
        ...
        % for name, label in views:
            <%
            view_url = i18n_url('filemanager:filelist', path=path, view=name)
            current = name == view
