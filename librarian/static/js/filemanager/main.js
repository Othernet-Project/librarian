...
(function(window, $, templates) {
  'use strict';
  var activateSidebar, closeSidebar, mainContainer, openSidebar, searchInput, toggleSidebar, updateState;
  ...
  mainContainer.on('click', '.views-tabs-tab-go-back', function(e) {
    var elem, res, url;
    e.preventDefault();
    e.stopPropagation();
    elem = $(this);
